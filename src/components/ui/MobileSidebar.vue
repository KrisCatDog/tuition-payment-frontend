<template>
  <transition name="sidebar-popout">
    <aside
      id="sidebar-mobile"
      class="fixed inset-y-0 z-20 flex-shrink-0 w-68 mt-16 overflow-y-auto bg-white dark:bg-gray-800 md:hidden"
      v-show="isVisible"
    >
...
.sidebar-popout-enter-active {
  @apply transition ease-in-out duration-150;
}
.sidebar-popout-enter-to {
  @apply opacity-100;
}
.sidebar-popout-leave-from {
  @apply opacity-100;
}
.sidebar-popout-leave-active {
