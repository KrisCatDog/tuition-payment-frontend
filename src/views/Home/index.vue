<template>
  <AppLayout>
    ...
    <h3
      v-if="authUser.role.name === 'administrator'"
      class="text-xl font-extrabold text-gray-700 dark:text-gray-200"
    >
    ...
    <div
      v-if="authUser.role.name === 'administrator'"
      class="my-4 w-full overflow-hidden rounded-lg shadow-sm"
    >
        ...
        <span class="flex col-span-4 mt-2 sm:mt-auto sm:justify-end">
          <nav aria-label="Table navigation">
            <ul class="inline-flex items-center">
              <li>
                <button
                  @click.prevent="handleFetch(paginationMeta.current_page - 1)"
