<template>
  <AppLayout>
    ...
    <AppModal
      ...
      title="Sukses!"
      description="Data Petugas berhasil di tambahkan."
      buttonText="OK"
      modalIcon="success"
...
const TheList = defineAsyncComponent(() =>
  import("@/components/officer/TheList")
);
...
export default {
  ...
  setup() {
    ...
    async function handleFetch(page, search = "") {
      await fetchOfficer(page, perPage.value, search);
    }

    async function handleSubmit() {
      await storeOfficer(formData);
